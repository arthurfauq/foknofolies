      ...
      <div className="section-content">
        ...
        <div className="slide description-zone fp-auto-height" data-anchor="programme-samedi-aprem">
          ...
          <p className="description-text">
            Un grand nombre d&apos;activités ludiques sont prévues pour vous divertir: piscine, quidditch, twerk
            contest, pétanque, molkky, pierre feuille ciseau, beer pong, badminton, chifoubaffes...
          </p>
        </div>
        <div className="slide description-zone fp-auto-height" data-anchor="programme-samedi-soir">
          ...
          <hr className="fadeLeft" />
          <p className="description-text">
            Aucune corne de brume ne sonnera la fin de l&apos;apéro, libre à vous donc de rejoindre le dancefloor le
            plus réputé de la région quand bon vous semble. Quelques artistes feront peut-être leur apparition sur scène
            pour vous divertir, mais c&apos;est peu probable.
          </p>
        ...
        <div className="slide description-zone fp-auto-height" data-anchor="programme-dimanche">
          ...
          <hr className="fadeLeft" />
          <p className="description-text">
            Pour vous remettre de vos émotions et bien entamer cette belle gueule de bois dominicale, un brunch est
            prévu. Les FoknoFolies ne se terminant jamais pour de bon, vous pourrez profiter du soleil ou de la pluie
