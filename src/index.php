...
<head>
    <title>FoknoFolies | Édition #3 | 7 - 8 Juillet 2018</title>

    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="author" content="Arthur Fauquenot">
    <meta name="description" content="Site web de la troisième édition des FoknoFolies. Retrouvez ici toutes les informations sur cette édtion : programme, itinéraire, gallerie, contact...">
...
<?php } else {
 if (!isset($_SESSION['PARTICIPANT']) || $_SESSION['PARTICIPANT'] == false) {?>
    <div class="container-fluid flexbox">
        <div class="v-align">
            <img src="./assets/images/logo-foknofolies.jpg" alt="Logo FoknoFolies" class="logo">
                <div class="section-content">
  ...
  ?>
    ...
    <div id="full-page">
        ...
        <div class="section" id="itineraire-section" data-anchor="itineraire">
            <div class="container-fluid flexbox">
                <div class="section-content v-align animated">
                    ...
                    <a href="https://www.google.fr/maps/dir//47.75323,1.968723/@47.7522661,1.9340387,13z/data=!3m1!4b1!4m2!4m1!3e0" target="_blank" class="large-button">Go</a>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid flexbox">
                <div class="section-content">
                    ...
                    <div class="slide description-zone fp-auto-height" data-anchor="programme-samedi-aprem">
                        ...
                        <hr class="fadeLeft">
                        <p class="description-text">Un grand nombre d'activités ludiques sont prévues pour vous divertir : Piscine, Olympiades, Kro Lanta, Pétanque, Molkky, 24h Krono, Beer Pong, Badminton, Chifoubaffes...</p>
                    </div>
                    <div class="slide description-zone fp-auto-height" data-anchor="programme-samedi-soir">
                        ...
                        <hr class="fadeLeft">
                        <p class="description-text">Aucune corne de brume ne sonnera la fin de l'apéro, libre à vous donc de rejoindre le dancefloor le plus réputé de la région quand bon vous semble. Quelques artistes feront peut-être leur apparition sur scène pour vous divertir,
                    ...
                    <div class="slide description-zone fp-auto-height" data-anchor="programme-dimanche">
                        ...
                        <hr class="fadeLeft">
                        <p class="description-text">Pour vous remettre de vos émotions et bien entamer cette belle gueule de bois dominicale, un brunch est prévu. Les FoknoFolies ne se terminant jamais pour de bon, vous pourrez profiter du soleil ou de la pluie jusqu'à la fin de la journée.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="section" id="cagnotte-section" data-anchor="cagnotte">
            <div class="container-fluid flexbox">
                <div class="section-content v-align">
                    <h2>Cagnotte</h2>
                    <div class="description-zone">
                    <div class="description-text">Nous vous demandons une participation de 20€ minimum, qui comprend de quoi vous abreuver, vous empiffrer et vous divertir tout le week-end.</div>
                    </div>
                    <a href="https://cagnotte.me/937-foknofolies" target="_blank" class="large-button">Lien</a>
                </div>
            </div>
        </div>
        ...
        <div class="section" id="gallerie-section" data-anchor="gallerie">
            <div class="container-fluid flexbox">
                <div class="section-content">
                    <h2>Gallerie</h2>
                    <p class="sub-title">Aperçu des deux premières éditions</p>
                    <div class="owl-container">
                        <div class="owl-carousel">
                            <img src="./assets/images/gallerie/image-17-min.jpg" alt="Slide image - House">
                            <img class="owl-lazy" data-src="./assets/images/gallerie/image-19-min.jpg" alt="Slide image - House">
                            <img class="owl-lazy" data-src="./assets/images/gallerie/image-18-min.jpg" alt="Slide image - House">
                            <img class="owl-lazy" data-src="./assets/images/gallerie/image-23-min.jpg" alt="Slide image - House">
                            ...
                            <img class="owl-lazy" data-src="./assets/images/gallerie/image-22-min.jpg" alt="Slide image - House">
                            ...
                            <img class="owl-lazy" data-src="./assets/images/gallerie/image-20-min.jpg" alt="Slide image - House">
                            <img class="owl-lazy" data-src="./assets/images/gallerie/image-21-min.jpg" alt="Slide image - House">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBfBqq9AJCOsIRQ_B2iDDUWo3DPQodebFY"></script>
    <?php }
}
?>
</body>
